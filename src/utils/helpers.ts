...
export const normalizeArticle = (newsArticle: NewsApiArticle | GuardianArticle | NYTArticle, source: string): Article => {
  let normalizedArticle: Article;

  switch (source) {
    case 'newsapi': {
      const article = newsArticle as NewsApiArticle;
      normalizedArticle = {
        id: article.url,
    ...
    case 'guardian': {
      const article = newsArticle as GuardianArticle;
      normalizedArticle = {
        id: article.id,
    ...
    case 'nyt': {
      const article = newsArticle as NYTArticle;
      normalizedArticle = {
